// const addBtn = document.querySelector('[data-action="plus"]');

// const removeBtn = document.querySelector('[data-action="minus"]');
...
// 			price: card.querySelector('[data-outPrice]').innerText,
// 		}
...
//                             -
//                           </div>
//                           <div class="items__current" data-counter=>1
//                         </div>
//                         <div class="items__control" data-action="plus">+</div>
//                       </div>
//                       <div class="item__price">
//                         <div class="price__current">${productInfo.price}</div>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
